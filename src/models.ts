...
export const SUPPORTED_MODELS: ModelInfo[] = [
  ...
  // ── OpenAI ──────────────────────────────────────────────────────────────
  {
    ...
    name: 'GPT-4.1 Nano',
    provider: 'OpenAI',
    description: 'Fastest and cheapest OpenAI model. Great for classification and autocomplete.',
    ...
    speed: 'fast',
    nativeTools: [],
    notes: '1M context window, ultra-low latency',
  },
  {
    id: 'openai/gpt-5-nano',
    name: 'GPT-5 Nano',
    provider: 'OpenAI',
    description: 'Smallest GPT-5 variant. Ultra-low latency for lightweight tasks.',
    inputModalities: ['text', 'image'],
    ...
    speed: 'fast',
    nativeTools: ['thinking'],
    notes: 'Mandatory reasoning, 400K context',
  },
  {
    id: 'openai/gpt-4o-mini',
    name: 'GPT-4o Mini',
    provider: 'OpenAI',
    description: 'Solid generalist. Good balance of cost and capability.',
    inputModalities: ['text', 'image'],
  ...
  },
  {
    ...
    name: 'GPT-5 Mini',
    provider: 'OpenAI',
    description: 'Compact GPT-5 for lightweight reasoning. Reduced latency vs full GPT-5.',
    inputModalities: ['text', 'image'],
    maxInputTokens: 400_000,
    maxOutputTokens: 128_000,
    inputPricePerM: 0.25,
    ...
    notes: '400K context, web search built-in',
  },
  {
    id: 'openai/o4-mini',
    name: 'o4-mini',
    provider: 'OpenAI',
    description: 'Competitive reasoning and coding. Solves multi-step tasks fast.',
    inputModalities: ['text', 'image'],
  ...
  },
  {
    ...
    name: 'GPT-5 Chat',
    provider: 'OpenAI',
    description: 'Advanced multimodal chat. Natural context-aware conversations.',
    inputModalities: ['text', 'image'],
    maxInputTokens: 128_000,
    maxOutputTokens: 16_384,
    inputPricePerM: 1.25,
  ...
  },
  {
    ...
    name: 'GPT-5.1 Chat',
    provider: 'OpenAI',
    description: 'Fast 5.1 family member. Adaptive reasoning with input caching.',
    inputModalities: ['text', 'image'],
    maxInputTokens: 128_000,
    maxOutputTokens: 16_384,
    inputPricePerM: 1.25,
    ...
    speed: 'medium',
    nativeTools: ['web_search'],
    notes: 'Input caching, web search built-in',
  },
  {
